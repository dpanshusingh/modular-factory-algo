...
const getNotesByTravelerRef = (dcOrVars, vars) => {
  const { dc: dcInstance, vars: inputVars} = validateArgs(connectorConfig, dcOrVars, vars, true);
  dcInstance._useGeneratedSdk();
  return queryRef(dcInstance, 'GetNotesByTraveler', inputVars);
}
getNotesByTravelerRef.operationName = 'GetNotesByTraveler';
exports.getNotesByTravelerRef = getNotesByTravelerRef;

exports.getNotesByTraveler = function getNotesByTraveler(dcOrVars, vars) {
...
const getTravelerRef = (dc) => {
  const { dc: dcInstance} = validateArgs(connectorConfig, dc, undefined);
  dcInstance._useGeneratedSdk();
  return queryRef(dcInstance, 'GetTraveler');
}
getTravelerRef.operationName = 'GetTraveler';
exports.getTravelerRef = getTravelerRef;

exports.getTraveler = function getTraveler(dc) {
...
const getCurrentTravelerStationsRef = (dcOrVars, vars) => {
  const { dc: dcInstance, vars: inputVars} = validateArgs(connectorConfig, dcOrVars, vars, true);
  dcInstance._useGeneratedSdk();
...
exports.getCurrentTravelerStationsRef = getCurrentTravelerStationsRef;

exports.getCurrentTravelerStations = function getCurrentTravelerStations(dcOrVars, vars) {
  return executeQuery(getCurrentTravelerStationsRef(dcOrVars, vars));
};

const getTravelerStationsQamProgressRef = (dcOrVars, vars) => {
  const { dc: dcInstance, vars: inputVars} = validateArgs(connectorConfig, dcOrVars, vars, true);
  dcInstance._useGeneratedSdk();
...
exports.getTravelerStationsQamProgressRef = getTravelerStationsQamProgressRef;

exports.getTravelerStationsQamProgress = function getTravelerStationsQamProgress(dcOrVars, vars) {
