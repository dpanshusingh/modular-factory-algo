...
import { createManyModuleCharacteristics, createModuleCharacteristic, deleteModuleCharacteristic, deleteModuleCharacteristicsByIdController, getAllModuleCharacteristics, getModuleCharacteristicsByIdController, updateManyModuleCharacteristics, updateModuleCharacteristic } from "../controllers/data_connect/moduleCharacteristicController";
