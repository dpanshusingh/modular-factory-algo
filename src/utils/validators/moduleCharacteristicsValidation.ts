...
export const createModuleCharacteristicSchema = yup.object({
  moduleProfileId: yup.string().uuid('Invalid moduleProfileId').required('moduleProfileId is required'),
...
export const updateModuleCharacteristicSchema = yup.object({
  moduleProfileId: yup.string().uuid('Invalid moduleProfileId').nullable(),
  characteristicType: yup.string().nullable(),
  value: yup.number().nullable(),
});
